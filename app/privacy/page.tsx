...
export default function PrivacyPage() {
  return <AppShell><InfoPage eyebrow="개인정보 보호" title="개인정보 처리 안내" intro="PDF Toolkit은 파일을 서버에 업로드하지 않는 브라우저 내 처리 방식을 사용합니다.">
    ...
    <section><h2>분석과 제3자 제공</h2><p>웹 서비스의 제품 이벤트는 별도의 광고·추적 서비스에 제공하지 않습니다. 이벤트 로그와 일반적인 접속 로그는 웹 호스팅 인프라에서 처리될 수 있지만, 서비스 코드는 파일 이름이나 파일 내용, 개인 식별자를 로그에 포함하지 않습니다. 데스크톱 앱은 로컬 제품 이벤트를 서버로 전송하지 않습니다.</p></section>
